...
local function CameraMove()
    ...
    if player and player:isDead() then
        ...
        local sX, sY, sZ = ISPostDeathUI.spectateOffsets.x, ISPostDeathUI.spectateOffsets.y, math.floor(ISPostDeathUI.spectateOffsets.z)
        LST_zone.teleportEntity(player, sX, sY, sZ)
